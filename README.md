...
Key Features: Dual independent I2C buses (Arm: pins 20/21, Torso: 8/9), Real-time angle calculation: Pitch/Roll via atan2 formulas, Medical-style serial output: Angle | Movement | Max_ROM | Progress% | Status, 120ms update rate, battery-optimized, Session-based peak ROM tracking.
